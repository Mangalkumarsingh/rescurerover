...
import com.example.rescuerover.databinding.ActivityRescueInputBinding
...
class rescueInputActivity : AppCompatActivity() {
    ...
    lateinit var binding: ActivityRescueInputBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityRescueInputBinding.inflate(layoutInflater)
    ...
    private fun rescueDataLoad() {
        ...
        dbRef= FirebaseDatabase.getInstance().getReference("rescue_data")
...
//    private fun rescueImage(request1: Int=2) {
//        if(uri==null) return
//        var file= UUID.randomUUID().toString()
//        binding.progressBar2.visibility= View.VISIBLE
//        var ref= Firebase.storage.reference.child("rescueImages/$file")
...
//    }
    ...
    private fun compressAndUploadImage(imagePath: Uri) {
        ...
        var ref = Firebase.storage.reference.child("rescueImage/$file1")
