...
import com.example.rescuerover.databinding.ActivityGarbageInputBinding
...
class garbageInputActivity : AppCompatActivity() {


    var model= garbageModel()
    var uri: Uri?=null
    ...
    lateinit var binding: ActivityGarbageInputBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityGarbageInputBinding.inflate(layoutInflater)
        ...
        var locationAdapter= ArrayAdapter(this,
            android.R.layout.simple_dropdown_item_1line,AreaLocation)
    ...
    private fun garbageDataLoad() {
        ...
        dbRef= FirebaseDatabase.getInstance().getReference("garbage_data")
...
//    private fun garbageImage(request1: Int) {
//        if(uri==null) return
//        var file= UUID.randomUUID().toString()
//        binding.progressBar2.visibility= View.VISIBLE
//        var ref= Firebase.storage.reference.child("garbageImages/$file")
...
private fun compressAndUploadImage(imagePath: Uri) {
    ...
    var ref = Firebase.storage.reference.child("garbageImages/$file1")
